...
import { setDisplayValue, handleUtility, buttonAction, Calculator } from "../calculator.js";
...
describe("Calculation Functions", function () {
	...
	describe("add", function () {
		...
		it("should add 2 integer numbers together and return result", function () {
			const firstNumber = 2;
		...
		it("should add 2 float numbers together and return result", function () {
			const firstNumber = 1.3;
			const secondNumber = 6.2;
			const result = 7.5;
			expect(calculatorTEST.add(firstNumber, secondNumber)).to.equal(result);
		});
	});
	describe("subtract", function () {
		...
		it("should subtract second number from first and return result", function () {
			...
			const result = 6;
			expect(calculatorTEST.subtract(firstNumber, secondNumber)).to.equal(result);
		});
	...
	describe("multiply", function () {
		...
		it("should multiply 2 numbers and return result", function () {
			...
			const secondNumber = 3;
			const result = 6;
			expect(calculatorTEST.multiply(firstNumber, secondNumber)).to.equal(result);
		});
...
describe("Operator Functions", function () {
	...
	it("should return correct result from Multiply function when x input", function () {
		calculatorTEST.operator = "x";
		calculatorTEST.lastNum = "2";
		calculatorTEST.updateCurrentNum("3");
		const result = "6";
...
describe("Event Functions", function () {
	...
	describe("Number button", function () {
		...
		it("should append a decimal onto current number", function () {
			const currentNum = "123";
			calculatorTEST.currentNum = currentNum;
			const newNum = ".2";
		...
		it("should not allow more than digit to be added after decimal", function () {
			const currentNum = "123.2";
			calculatorTEST.currentNum = currentNum;
			const newNum = "5";

			buttonAction(calculatorTEST, "number", newNum);
			expect(calculatorTEST.currentNum).to.equal(currentNum);
		});
		...
		it("should update display value with new current number with a decimal place", function () {
			calculatorTEST.currentNum = "150.";

			buttonAction(calculatorTEST, "number", "5");
			expect(calculatorTEST.displayValue).to.equal(calculatorTEST.currentNum);
		});
	});
	...
	describe("Operator button", function () {
		...
		it("should update display value with new operator", function () {
			...
			buttonAction(calculatorTEST, "operator", "x");
	...
	describe("Utility button", function () {
		it("should perform equals function if '=' passed", function () {
			...
			buttonAction(calculatorTEST, "utility", button);
			expect(calculatorTEST.currentTotal).to.equal(result);
		});
...
describe("Exception handling", function () {
	...
	it("should return TypeError if division by 0 attempted", function () {
		...
		expect(() => calculatorTEST.divide(firstNumber, secondNumber)).to.throw(TypeError, error);
	});

	it("should return a TypeError if invalid operator input", function () {
		const error = "Invalid Operator";

		expect(() => calculatorTEST.performCalculation("$", "2", "3")).to.throw(TypeError, error);
	});

	it("should return a TypeError if more than 1 digit input is attempted after decimal", function () {
		const newNum = "2";
		calculatorTEST.currentNum = "4879.8";
		const error = "Only one digit allowed after decimal place";

		expect(() => calculatorTEST.updateCurrentNum(newNum)).to.throw(TypeError, error);
	});
});
